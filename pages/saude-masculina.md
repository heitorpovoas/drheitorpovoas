...
subtitle: "Avaliação de DAEM e composição corporal no homem adulto. Diagnóstico criterioso, tratamento quando indicado."
permalink: /saude-masculina/
---
...
<h3 style="margin: 0 0 0.5rem 0; color: var(--blue, #1F4E79); font-size: 1.1rem;">Questionário DAEM</h3>
<p style="margin: 0 0 0.75rem 0; font-size: 0.95rem;">Avaliação inicial de sintomas sugestivos de hipoandrogenismo (AMS + ADAM). Triagem preliminar — diagnóstico de DAEM exige confirmação laboratorial e exclusão de causas secundárias.</p>
<a href="https://heitorpovoas.github.io/escalas-hi/DAEM_Questionario_Digital.html" style="font-weight: 600; color: var(--blue, #1F4E79);">Acessar questionário →</a>
</div>

<div style="border-left: 4px solid var(--gold, #C9A961); padding: 1rem 1.25rem; background: #FDF8EC;">
<h3 style="margin: 0 0 0.5rem 0; color: var(--blue, #1F4E79); font-size: 1.1rem;">Avaliação do Sono</h3>
<p style="margin: 0 0 0.75rem 0; font-size: 0.95rem;">Triagem para apneia obstrutiva do sono (STOP-BANG) e sonolência diurna (Escala de Epworth). Particularmente importante para homem com obesidade, em uso de TRT ou pós-bariátrica.</p>
...
[Agende uma consulta pelo WhatsApp](https://wa.me/{{ site.doctor.whatsapp }}) — {{ site.doctor.whatsapp_display }}.
